      ...
      render() {
                return (
                    <div>
                        ...
                        <div><Permission /></div> 
                        <nav className="w3-sidebar w3-collapse w3-white" style={{zIndex: 3, width: '15%', marginLeft:'2%', marginTop:'0px'}} id="mySidebar"><br />
                          ...
                          <div className="w3-bar-block">
                            ...
                            <a href="/Menu" className="w3-bar-item w3-button w3-padding"><i className="fa fa-eye fa-fw" /><Link to="/Menu">&nbsp; Menu</Link></a>
                            {/*<Link to="https://viblo.asia/p/co-ban-ve-router-trong-reactjs-07LKXzAElV4">Menu</Link>*/}
