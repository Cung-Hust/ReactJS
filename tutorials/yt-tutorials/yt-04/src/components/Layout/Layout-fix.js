...
class Layout extends Component {
    render() {
            ...
            <div>
                <div className='layout' style={{width:'1500px', padding:'0', margin:'0 auto'}}>                
                    ...
                    <div id="header" style={{width:'1500px', float:'left', borderBottom:'1px dashed #AAA'}}>
                        ...
                        <h2 style={{marginTop:'5px', marginLeft:'10px', color:'black'}}> Operation Monitoring - F2 </h2>
                        </div>
        ...
        *********************************************************************************************************************************************************** */}
                        ...
                        <div className="Zone-3" style={{width:'500px', float:'left', backgroundColor:'light'}}>
                        <div className='row-1'>
        ...
        *********************************************************************************************************************************************************** */}
                    ...
                    <div id="footer" style={{width:'1500px', float:'left', marginTop:'5px', borderTop:'1px dashed #AAA'}}>
                        <h5 style={{marginTop:'3px'}}> &nbsp;&nbsp;&nbsp;&nbsp;Khi máy dừng quá thời gian cho phép thì vị trí máy sẽ nhấp nháy cảnh báo ! - Machine's position will blink when stopped over allowed stop duration ! </h5>
                    </div>
                    </div>
                </div>
            </div>
